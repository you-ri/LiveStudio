...
### Material Symbols — `cards` icon

- File: `Editor/Icons/cards.png`
- Source: https://github.com/google/material-design-icons
- License: Apache License 2.0
- Copyright: (c) Google LLC

The `Editor/Icons/cards.png` toolbar icon is derived from the "cards" glyph of Google's
Material Symbols (Outlined). The source SVG was rasterized to PNG and recolored white for
runtime tinting; no other changes were made. Material Symbols is distributed under the
Apache License 2.0, the same license used by this package; per Section 4(c) of that license,
attribution is provided in this notice.
