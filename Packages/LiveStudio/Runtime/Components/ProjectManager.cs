...
namespace Lilium.LiveStudio
{
    ...
    public static class ProjectManager
    {
        ...
        // None of the three intervals below are on the live data: they tune how often the remote app
        // asks this machine for things, which is a property of the operator's setup rather than of
        // the world being recorded. Saying where they are saved is the whole of saying that -- the
        // lane follows from the scope (FrameLaneRules).
