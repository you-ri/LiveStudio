...
namespace Lilium.LiveStudio
{
    ...
    public class SetBundleAsset : SetAssetBase
    {
        ...
        public override Scene scene => _loaded != null ? _loaded.scene : default;

        /// <summary>True when a valid scene is currently loaded.</summary>
        public override bool hasScene => _loaded != null && _loaded.scene.IsValid() && _loaded.scene.isLoaded;
