...
namespace Lilium.LiveStudio.Virgo.Editor
{
    ...
    static class StudioToolbarButton
    {
        ...
        static void OnDropdownClicked(Rect rect)
        {
            ...
            menu.AddItem(new GUIContent("Clear Current Data"), false, () => { foreach (var p in Object.FindObjectsOfType<Lilium.RemoteControl.LiveScene.RemoteControlBehaviour>()) p.ClearCurrentData(); });
            menu.AddSeparator("");
