...
namespace Lilium.RemoteControl.Tests
{
    ...
    public class WebUITests
    {
        ...
        #region WebUIDefinition Tests

        [Test]
        public void WebUIDefinition_DefaultMenuItems_IsEmptyList()
        {
            var definition = ScriptableObject.CreateInstance<WebUIDefinition>();
            try
            {
        ...
        [Test]
        public void WebUIDefinition_AddMenuItems_RetainsItems()
        {
            var definition = ScriptableObject.CreateInstance<WebUIDefinition>();
            try
            {
        ...
        #region WebUIHandler Registration Tests

        [Test]
        public void WebUIHandler_RegistersSelectorsForCategoryPages()
        {
            ...
            try
            {
                ...
                // WebUIHandler のコンストラクタで selector が ExposedObject として登録される
                var handler = new WebUIHandler(null, definition);

                var selectorObj = ExposedObjectRegistry.FindById("webui.selector.test-page");
                Assert.IsNotNull(selectorObj, "Selector should be registered as ExposedObject");

                var factoryObj = ExposedObjectRegistry.FindById("webui.factory.test-page");
        ...
        [Test]
        public void WebUIHandler_Cleanup_UnregistersExposedObjects()
        {
            ExposedClass.RegisterFromAttributes<ObjectSelectorBase>();
            ExposedClass.RegisterFromAttributes<ObjectFactoryBase>();
            ...
            try
            {
                ...
                // 登録を確認
                Assert.IsNotNull(ExposedObjectRegistry.FindById("webui.selector.cleanup-page"));
                Assert.IsNotNull(ExposedObjectRegistry.FindById("webui.factory.cleanup-page"));

                // Cleanup
                handler.Cleanup();

                // 解除を確認
                Assert.IsNull(ExposedObjectRegistry.FindById("webui.selector.cleanup-page"));
                Assert.IsNull(ExposedObjectRegistry.FindById("webui.factory.cleanup-page"));
            }
            finally
            {
                ScriptableObject.DestroyImmediate(definition);
        ...
        [Test]
        public void WebUIHandler_NullDefinition_DoesNotThrow()
        {
            Assert.DoesNotThrow(() =>
            {
                var handler = new WebUIHandler(null, null);
                handler.Cleanup();
            });
        }

        [Test]
        public void WebUIHandler_EmptyDefinition_DoesNotThrow()
        {
            var definition = ScriptableObject.CreateInstance<WebUIDefinition>();
            try
            {
        ...
        [Test]
        public void WebUIHandler_MenuItemWithoutPage_DoesNotThrow()
        {
            ExposedClass.RegisterFromAttributes<ObjectSelectorBase>();
        ...
        [Test]
        public void WebUIHandler_MultipleMenuItems_RegistersAllSelectors()
        {
            ExposedClass.RegisterFromAttributes<ObjectSelectorBase>();
            ExposedClass.RegisterFromAttributes<ObjectFactoryBase>();
            ...
            try
            {
                ...
                Assert.IsNotNull(ExposedObjectRegistry.FindById("webui.selector.page-a"));
                Assert.IsNotNull(ExposedObjectRegistry.FindById("webui.selector.page-b"));
                Assert.IsNotNull(ExposedObjectRegistry.FindById("webui.factory.page-a"));
                Assert.IsNotNull(ExposedObjectRegistry.FindById("webui.factory.page-b"));
        ...
        public void NavigateObjectSelector_SerializesStaticExposedObjectAsReference()
        {
            ...
            try
            {
                ...
                try
                {
                    var selectorObj = ExposedObjectRegistry.FindById("webui.selector.settings");
