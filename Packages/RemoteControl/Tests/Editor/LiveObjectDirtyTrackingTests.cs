...
{
    [TestFixture]
    public class LiveObjectDirtyTrackingTests
    {
        ...
        [Serializable]
        [LiveClass("TestDirtyNestedStruct")]
        ...
        [Serializable]
        [LiveClass("TestDirtyStructWithDefault")]
        ...
        [Serializable]
        [LiveClass("TestDirtyClassWithDefaultArray")]
        ...
        [Serializable]
        [LiveClass("TestDirtyMixedPersistence")]
        ...
        [Serializable]
        [LiveClass("TestDirtyClassWithList")]
        ...
        // List<参照型>の要素がそれぞれLiveObjectを持つケース
        [Serializable]
        [LiveClass("TestDirtyRefItem")]
        public class TestDirtyRefItem : ILiveObject
        {
        ...
        [Serializable]
        [LiveClass("TestDirtyContainerWithRefList")]
        ...
        public void SetUp()
        {
            ...
            // テストクラスを登録
            LiveClass.RegisterFromAttributes<TestDirtyNestedStruct>();
            LiveClass.RegisterFromAttributes<TestDirtyClass>();
            LiveClass.RegisterFromAttributes<TestDirtyClassWithArray>();
            LiveClass.RegisterFromAttributes<TestDirtyStructWithDefault>();
            LiveClass.RegisterFromAttributes<TestDirtyClassWithDefaultArray>();
            LiveClass.RegisterFromAttributes<TestDirtyClassWithList>();
            LiveClass.RegisterFromAttributes<TestDirtyRefItem>();
            LiveClass.RegisterFromAttributes<TestDirtyContainerWithRefList>();
            LiveClass.RegisterFromAttributes<TestClassWithPlainStructField>();
            LiveClass.RegisterFromAttributes<TestClassWithPlainSerializableProperty>();
            LiveClass.RegisterFromAttributes<TestClassWithReadOnlyPlainProperty>();
        ...
        public void ValueChanged_SingleProperty_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-1", liveClass, testObj);

            // Act - デフォルト値をキャプチャしてから値を変更
            liveObj.SetDefault("value", testObj.value);
            testObj.value = 100;

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("value"));
            Assert.IsTrue(liveObj.isDirty);
        }
        ...
        public void ValueChanged_MultipleProperties_DetectsAllDirty()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-2", liveClass, testObj);

            // Act - デフォルト値をキャプチャしてから値を変更
            liveObj.SetDefault("value", testObj.value);
            liveObj.SetDefault("name", testObj.name);
            liveObj.SetDefault("position", testObj.position);
            testObj.value = 100;
            testObj.name = "Changed";

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("value"));
            Assert.IsTrue(liveObj.IsPropertyDirty("name"));
            Assert.IsFalse(liveObj.IsPropertyDirty("position"));
        }
        ...
        public void EnsureDefaultCaptured_NonExistentProperty_DoesNotThrow()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-3", liveClass, testObj);

            // Act & Assert - EnsureDefaultCapturedは例外を投げない
            Assert.DoesNotThrow(() => liveObj.EnsureDefaultCaptured("nonExistent"));
            // 存在しないプロパティはFindPropertyがnullを返すためdirtyにならない
            Assert.IsFalse(liveObj.IsPropertyDirty("nonExistent"));
        }
        ...
        public void ValueChanged_ChildProperty_DetectedByHasDirtyChild()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-4", liveClass, testObj);

            // Act - デフォルト値をキャプチャしてから値を変更
            liveObj.SetDefault("nested.name", testObj.nested.name);
            testObj.nested = new TestDirtyNestedStruct { id = 1, name = "Changed" };

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("nested.name"), "Child property should be dirty");
            Assert.IsTrue(liveObj.HasDirtyChildProperty("nested"), "Parent should detect dirty child");
        }
        ...
        public void ValueChanged_ArrayElement_DetectedByHasDirtyChild()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-dirty-6", liveClass, testObj);

            // Act - SetValue経由で値を変更（EnsureDefaultCapturedが自動で呼ばれる）
            var prop = liveObj.FindProperty("items[0].name");
            Assert.IsNotNull(prop);
            prop.Value.SetValue("Changed");

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("items[0].name"), "Element property should be dirty");
            Assert.IsTrue(liveObj.HasDirtyChildProperty("items[0]"), "Array element should have dirty child");
            Assert.IsTrue(liveObj.HasDirtyChildProperty("items"), "Array itself should have dirty child");
        }
        ...
        public void ValueChanged_SiblingProperty_DoesNotAffectSibling()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-7", liveClass, testObj);
            ...
            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("name"));
            Assert.IsFalse(liveObj.IsPropertyDirty("value"), "Sibling should not be dirty");
            Assert.IsFalse(liveObj.IsPropertyDirty("position"), "Sibling should not be dirty");
        }
        ...
        public void ValueChanged_NestedSiblingProperty_DoesNotAffectSibling()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-8", liveClass, testObj);

            // Act - nested.nameのみ変更
            liveObj.SetDefault("nested.name", testObj.nested.name);
            liveObj.SetDefault("nested.id", testObj.nested.id);
            testObj.nested = new TestDirtyNestedStruct { id = 1, name = "Changed" };

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("nested.name"));
            Assert.IsTrue(liveObj.HasDirtyChildProperty("nested"), "Parent should detect dirty child");
            Assert.IsFalse(liveObj.IsPropertyDirty("nested.id"), "Sibling property should not be dirty");
        }
        ...
        public void HasDirtyChildProperty_WithDirtyChild_ReturnsTrue()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-9", liveClass, testObj);

            // Act - SetValue経由で値を変更
            var prop = liveObj.FindProperty("nested.name");
            Assert.IsNotNull(prop);
            prop.Value.SetValue("Changed");

            // Assert
            Assert.IsTrue(liveObj.HasDirtyChildProperty("nested"));
        }
        ...
        public void HasDirtyChildProperty_WithoutDirtyChild_ReturnsFalse()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-10", liveClass, testObj);
            ...
            // Assert
            Assert.IsFalse(liveObj.HasDirtyChildProperty("nested"));
        }
        ...
        public void HasDirtyChildProperty_EmptyPath_ReturnsIsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-11", liveClass, testObj);
            ...
            // Assert
            Assert.IsTrue(liveObj.HasDirtyChildProperty(""));
            Assert.IsTrue(liveObj.HasDirtyChildProperty(null));
        }
        ...
        public void ClearDirty_AllProperties_ClearsAll()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-12", liveClass, testObj);
            ...
            Assert.IsTrue(liveObj.isDirty, "Should be dirty before ClearDirty");

            // Act
            liveObj.ClearDirty();

            // Assert
            Assert.IsFalse(liveObj.isDirty);
            Assert.IsFalse(liveObj.IsPropertyDirty("value"));
            Assert.IsFalse(liveObj.IsPropertyDirty("name"));
            Assert.IsFalse(liveObj.IsPropertyDirty("position"));
        }
        ...
        public void ClearPropertyDirty_SingleProperty_ClearsOnlyTarget()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-13", liveClass, testObj);
            ...
            // Act
            liveObj.ClearPropertyDirty("value");

            // Assert
            Assert.IsFalse(liveObj.IsPropertyDirty("value"), "Cleared property should not be dirty");
            Assert.IsTrue(liveObj.IsPropertyDirty("name"), "Other property should still be dirty");
            Assert.IsTrue(liveObj.isDirty, "Object should still be dirty");
        }
        ...
        public void Reset_DirtyProperty_RestoresDefaultValue()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-14", liveClass, testObj);
            ...
            // Act
            bool result = liveObj.Revert("value");

            // Assert
            Assert.IsTrue(result);
            Assert.AreEqual(42, testObj.value, "Value should be restored to default");
            Assert.IsFalse(liveObj.IsPropertyDirty("value"), "Property should no longer be dirty");
        }
        ...
        public void Reset_NonDirtyProperty_ReturnsTrue_BecauseDefaultIsCaptured()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-15", liveClass, testObj);
        ...
        public void LiveSceneToJson_DeltaFromDefault_OnlyOutputsDirtyProperties()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-16", liveClass, testObj);
        ...
        public void LiveSceneToJson_DeltaFromDefault_ArrayElementPartialDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-dirty-17", liveClass, testObj);
        ...
        public void FromJson_PartialUpdate_OnlyMarksDirtyOnChangedProperties()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-18", liveClass, testObj);
            ...
            Assert.IsTrue(liveObj.IsPropertyDirty("name"), "name should be dirty");
            Assert.IsFalse(liveObj.IsPropertyDirty("value"), "value should not be dirty");
            Assert.IsFalse(liveObj.IsPropertyDirty("position"), "position should not be dirty");
        }
        ...
        public void FromJson_NestedPartialUpdate_OnlyMarksDirtyOnChangedNestedProperties()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-19", liveClass, testObj);
            ...
            Assert.IsTrue(liveObj.IsPropertyDirty("nested.name"), "nested.name should be dirty");
            Assert.IsTrue(liveObj.HasDirtyChildProperty("nested"), "nested should have dirty child");
            Assert.IsFalse(liveObj.IsPropertyDirty("nested.id"), "nested.id should not be dirty");
            Assert.IsFalse(liveObj.IsPropertyDirty("value"), "value should not be dirty");
        }
        ...
        public void GetDirtyProperties_ReturnsOnlyDirtyPaths()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-dirty-20", liveClass, testObj);
            ...
            // Act
            var dirtyProps = liveObj.GetDirtyProperties();
        ...
        public void MarkClean_ClearsDirtyWithoutRevertingValues()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-markclean-1", liveClass, testObj);
            LiveObjectDefaultRegistry.CaptureDefaults(liveObj, DefaultLiveObjectResolver.Instance);
            ...
            testObj.value = 100;
            Assume.That(liveObj.isDirty, Is.True, "precondition: applied value should be dirty");
        ...
        public void MarkClean_KeepsSerializationDefaults_SoDeltaSaveStillWritesTheOverride()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Saved", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-markclean-2", liveClass, testObj);
            LiveObjectDefaultRegistry.CaptureDefaults(liveObj, DefaultLiveObjectResolver.Instance);
            ...
            var defaults = LiveObjectDefaultRegistry.GetDefaults(liveObj);
        ...
        public void MarkClean_EditAfterwardsIsDirtyAgain()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Saved", position = 1.0f };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-markclean-3", liveClass, testObj);
            LiveObjectDefaultRegistry.CaptureDefaults(liveObj, DefaultLiveObjectResolver.Instance);

            testObj.value = 100;
            liveObj.MarkClean();
            Assume.That(liveObj.isDirty, Is.False, "precondition: clean right after MarkClean");
        ...
        public void IsDirty_IgnoresNonPersistableMembers()
        {
            ...
            LiveClass.RegisterFromAttributes<TestDirtyMixedPersistence>();
            var testObj = new TestDirtyMixedPersistence { saved = 1, runtimeOnly = 1 };
            var liveClass = LiveClass.Find(typeof(TestDirtyMixedPersistence));
            var liveObj = new LiveObjectHandle("test-persistable-1", liveClass, testObj);
            LiveObjectDefaultRegistry.CaptureDefaults(liveObj, DefaultLiveObjectResolver.Instance);
            liveObj.MarkClean();
            ...
            // Assert
            Assert.IsFalse(liveObj.isDirty, "a non-persistable change must not count as unsaved");

            // And the persistable one still does.
            testObj.saved = 2;
            Assert.IsTrue(liveObj.isDirty, "a persistable change must count as unsaved");
        }
        ...
        public void AddArrayElement_MarksOnlyJsonPropertiesDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-add-dirty-1", liveClass, testObj);

            var property = liveObj.FindProperty("items");
            ...
            // Act
            var result = LivePropertySerializer.AddArrayElement(json, property.Value);
            ...
            Assert.IsTrue(liveObj.IsPropertyDirty("items[0].name"), "items[0].name should be dirty");
            // JSONで設定していないidはdirtyにならない
            Assert.IsFalse(liveObj.IsPropertyDirty("items[0].id"), "items[0].id should NOT be dirty");
            // 配列と要素自体はdirty child
            Assert.IsTrue(liveObj.HasDirtyChildProperty("items[0]"), "items[0] should have dirty child");
            Assert.IsTrue(liveObj.HasDirtyChildProperty("items"), "items should have dirty child");
        }
        ...
        public void FromJson_NewArrayElement_SetsDefaultValueFromCreateDefaultElement()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithDefaultArray));
            var liveObj = new LiveObjectHandle("test-default-1", liveClass, testObj);
            ...
            var property0 = liveObj.FindProperty("items[0].value");
            ...
            var property1 = liveObj.FindProperty("items[1].value");
        ...
        public void FromJson_NewArrayElement_ResetRestoresToCreateDefaultElementValue()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithDefaultArray));
            var liveObj = new LiveObjectHandle("test-default-2", liveClass, testObj);
            ...
            // Act - 新規要素をリセット
            var property = liveObj.FindProperty("items[1].value");
            Assert.IsNotNull(property);
        ...
        public void FromJson_ExistingArrayElement_ResetRestoresToInitialValue()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithDefaultArray));
            var liveObj = new LiveObjectHandle("test-default-3", liveClass, testObj);
            ...
            // Act - 既存要素をリセット
            var property = liveObj.FindProperty("items[0].value");
            Assert.IsNotNull(property);
            property.Value.RevertValue();
        ...
        public void SetDefaultValue_StructWithNonDirtyChild_SkipsNonDirtyProperties()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-setdefault-1", liveClass, testObj);

            // nested.nameのみをSetValue経由で変更（EnsureDefaultCapturedが呼ばれる）
            var nestedNameProp = liveObj.FindProperty("nested.name");
            nestedNameProp.Value.SetValue("Changed");

            // nested.nameをリバート
            nestedNameProp = liveObj.FindProperty("nested.name");
            ...
            var nestedProp = liveObj.FindProperty("nested");
        ...
        public void SetDefaultValue_Property_ClearsDirtyByRevert()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-setdefault-2", liveClass, testObj);

            // SetValue経由で値を変更（EnsureDefaultCapturedが呼ばれる）
            var valueProp = liveObj.FindProperty("value") ?? throw new Exception("Property not found");
            valueProp.SetValue(100);
            Assert.IsTrue(liveObj.IsPropertyDirty("value"), "Property should be dirty after value change");

            // Act - リバートで値を戻す
            valueProp = liveObj.FindProperty("value") ?? throw new Exception("Property not found");
            valueProp.RevertValue();

            // Assert
            Assert.IsFalse(liveObj.IsPropertyDirty("value"), "Property should not be dirty after revert");
        }
        ...
        public void SetDefaultValue_Struct_ClearsDirtyFlagForParent()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-setdefault-3", liveClass, testObj);

            // nested.nameのみをSetValue経由で変更
            var nestedNameProp = liveObj.FindProperty("nested.name") ?? throw new Exception("Property not found");
            nestedNameProp.SetValue("Changed");

            // リバートして元の値に戻す
            nestedNameProp = liveObj.FindProperty("nested.name") ?? throw new Exception("Property not found");
            nestedNameProp.RevertValue();

            Assert.IsTrue(liveObj.HasDirtyChildProperty("nested") == false || !liveObj.IsPropertyDirty("nested.name"),
            ...
            var nestedProp = liveObj.FindProperty("nested") ?? throw new Exception("Property not found");
            nestedProp.RevertValue();

            // Assert
            // 子プロパティもすべてisDirty==falseになる
            Assert.IsFalse(liveObj.IsPropertyDirty("nested.id"), "nested.id should not be dirty after RevertValue");
            Assert.IsFalse(liveObj.IsPropertyDirty("nested.name"), "nested.name should not be dirty after RevertValue");
            // コンストラクタでSetDefaultが自動実行されるため、idもデフォルト値(1)にリバートされる
        ...
        public void ValueUnchanged_WithDefaultCaptured_NotDirty()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test" };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-compare-1", liveClass, testObj);

            // Act - デフォルト値をキャプチャするが値は変更しない
            liveObj.SetDefault("value", testObj.value);

            // Assert - 値が変わっていないのでdirtyではない
            Assert.IsFalse(liveObj.IsPropertyDirty("value"), "Unchanged value should not be dirty");
        }
        ...
        public void ExternalValueChange_DetectedAsDirty()
        {
            ...
            var testObj = new TestDirtyClass { value = 42, name = "Test" };
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-compare-2", liveClass, testObj);
            ...
            Assert.IsTrue(liveObj.IsPropertyDirty("value"), "Externally changed value should be detected as dirty");
        }
        ...
        public void ListAdd_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-add-1", liveClass, testObj);

            liveObj.SetDefault("intList", testObj.intList);

            // Act - List に要素を追加（in-place変更）
            testObj.intList.Add(4);

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("intList"), "List should be dirty after Add");
        }
        ...
        public void ListRemoveAt_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-remove-1", liveClass, testObj);
            ...
            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("intList"), "List should be dirty after RemoveAt");
        }
        ...
        public void ListReorder_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-reorder-1", liveClass, testObj);
            ...
            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("intList"), "List should be dirty after reorder");
        }
        ...
        public void ListUnchanged_NotDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-unchanged-1", liveClass, testObj);
            ...
            // Assert
            Assert.IsFalse(liveObj.IsPropertyDirty("intList"), "Unchanged List should not be dirty");
        }
        ...
        public void ListClear_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-clear-1", liveClass, testObj);
            ...
            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("intList"), "List should be dirty after Clear");
        }
        ...
        public void ListStringAdd_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-string-1", liveClass, testObj);

            liveObj.SetDefault("stringList", testObj.stringList);

            // Act
            testObj.stringList.Add("c");

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("stringList"), "String List should be dirty after Add");
        }
        ...
        public void ListStructAdd_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-struct-1", liveClass, testObj);

            liveObj.SetDefault("structList", testObj.structList);

            // Act
            testObj.structList.Add(new TestDirtyNestedStruct { id = 2, name = "Second" });

            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("structList"), "Struct List should be dirty after Add");
        }
        ...
        public void ListClearDirty_UpdatesDefaultToCurrentValue()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-cleardirty-1", liveClass, testObj);

            liveObj.SetDefault("intList", testObj.intList);
            testObj.intList.Add(4);
            Assert.IsTrue(liveObj.IsPropertyDirty("intList"), "Should be dirty before ClearDirty");

            // Act - ClearDirtyでデフォルト値を現在値に更新
            liveObj.ClearDirty();

            // Assert - dirtyが解消される
            Assert.IsFalse(liveObj.IsPropertyDirty("intList"), "List should not be dirty after ClearDirty");

            // さらに変更を加えると再びdirtyになる
            testObj.intList.Add(5);
            Assert.IsTrue(liveObj.IsPropertyDirty("intList"), "List should be dirty again after further Add");
        }
        ...
        public void ListElementModified_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-list-modify-1", liveClass, testObj);
            ...
            // Assert
            Assert.IsTrue(liveObj.IsPropertyDirty("intList"), "List should be dirty after element modification");
        }
        ...
        public void ContainerRefListAdd_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyContainerWithRefList));
            var containerLiveObj = new LiveObjectHandle("test-container-1", liveClass, testObj);

            // デフォルト値をキャプチャ（ObjectContainer.Initializeと同等）
            LivePropertyUtility.SetDefault(containerLiveObj);

            // Act - 新しい要素を追加（ObjectContainer.AddLiveObjectと同等）
            var item2 = new TestDirtyRefItem { name = "Item2", value = 20 };
            testObj.items.Add(item2);

            // Assert
            Assert.IsTrue(containerLiveObj.IsPropertyDirty("items"), "items list should be dirty after Add");
            Assert.IsTrue(containerLiveObj.isDirty, "Container should be dirty");
        }
        ...
        public void ContainerRefListRemove_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyContainerWithRefList));
            var containerLiveObj = new LiveObjectHandle("test-container-2", liveClass, testObj);
            ...
            // Assert
            Assert.IsTrue(containerLiveObj.IsPropertyDirty("items"), "items list should be dirty after Remove");
        }
        ...
        public void ContainerRefListAdd_LiveSceneToJson_DeltaFromDefault_OutputsItems()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyContainerWithRefList));
            var containerLiveObj = new LiveObjectHandle("test-container-3", liveClass, testObj);

            // 子要素のLiveObjectを登録
            var itemLiveClass = LiveClass.Find(typeof(TestDirtyRefItem));
            var item1LiveObj = new LiveObjectHandle("item-1", itemLiveClass, item1);
            ...
            // Act - 新しい要素を追加
            var item2 = new TestDirtyRefItem { name = "Item2", value = 20 };
            var item2LiveObj = new LiveObjectHandle("item-2", itemLiveClass, item2);
            testObj.items.Add(item2);
        ...
        public void ContainerRefListAdd_DeltaFromDefault_SaveLoad_AddedObjectPreservesDirtyFlag()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyContainerWithRefList));
            var containerLiveObj = new LiveObjectHandle("test-container-save-load", liveClass, testObj);

            var itemLiveClass = LiveClass.Find(typeof(TestDirtyRefItem));
            var item1LiveObj = new LiveObjectHandle("item-sl-1", itemLiveClass, item1);
            ...
            // Act - 新しい要素を追加
            var item2 = new TestDirtyRefItem { name = "Item2", value = 20 };
            var item2LiveObj = new LiveObjectHandle("item-sl-2", itemLiveClass, item2);
            testObj.items.Add(item2);
            ...
            // Assert - item2のLiveObjectはデフォルト値未設定のため dirty ではない
            // hasBaseline廃止後: デフォルト値が設定されていないプロパティはdirtyと見なさない
            Assert.IsFalse(item2LiveObj.isDirty,
        ...
        public void ContainerRefList_LiveSceneToJson_DeltaFromDefault_NonDirtyElementsAreEmptyStubs()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyContainerWithRefList));
            var containerLiveObj = new LiveObjectHandle("test-container-4", liveClass, testObj);

            // 子要素のLiveObjectを登録
            var itemLiveClass = LiveClass.Find(typeof(TestDirtyRefItem));
            new LiveObjectHandle("item-ref-1", itemLiveClass, item1);
            new LiveObjectHandle("item-ref-2", itemLiveClass, item2);
            ...
            new LiveObjectHandle("item-ref-3", itemLiveClass, item3);
        ...
        public void SetDefault_ThenLoadFromJson_ThenSaveDeltaFromDefault_PreservesLoadedValues()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-roundtrip-1", liveClass, testObj);
            ...
            var savedJson = LiveSceneSerializer.LiveSceneToJson(new List<LiveObjectHandle>(LiveObjectRegistry.instances), _resolver, SerializeMode.Delta);
        ...
        public void SetDefault_ThenLoadFromJson_ThenSaveDeltaFromDefault_NestedStruct_PreservesLoadedValues()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClass));
            var liveObj = new LiveObjectHandle("test-roundtrip-2", liveClass, testObj);
        ...
        public void SetDefault_ThenLoadFromJson_ThenSaveDeltaFromDefault_Array_PreservesLoadedValues()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-roundtrip-3", liveClass, testObj);
        ...
        public void DeltaFormat_ExistingElementPartialChange_OutputsChangedPropertiesOnly()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-delta-array-1", liveClass, testObj);
            LivePropertyUtility.SetDefault(liveObj);

            // items[1].name のみ変更
            var prop = liveObj.FindProperty("items[1].name");
            Assert.IsNotNull(prop);
            prop.Value.SetValue("Changed");
        ...
        public void DeltaFormat_TrailingUnchangedElements_AreOmitted()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-delta-array-2", liveClass, testObj);
            LivePropertyUtility.SetDefault(liveObj);
            ...
            Assert.IsTrue(LivePropertySerializer.IsArrayDeltaFormat(itemsArray), "Result should be detectable as delta format");
            ...
            Assert.IsFalse(LivePropertySerializer.HasNonMetaProperties(marker), "Trailing marker should be empty");
        }
        ...
        public void DeltaFormat_AddedElements_HaveNewFlag()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-delta-array-3", liveClass, testObj);
            LivePropertyUtility.SetDefault(liveObj);
            ...
            var itemsProp = liveObj.FindProperty("items");
        ...
        public void DeltaFormat_Deserialize_MergesPartialChanges()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-delta-array-4", liveClass, testObj);
            LivePropertyUtility.SetDefault(liveObj);
        ...
        public void DeltaFormat_Deserialize_AddsNewElements()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-delta-array-5", liveClass, testObj);
            LivePropertyUtility.SetDefault(liveObj);
        ...
        public void DeltaFormat_PrimitiveArray_NotDeltaFormat()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithList));
            var liveObj = new LiveObjectHandle("test-delta-array-6", liveClass, testObj);
            LivePropertyUtility.SetDefault(liveObj);

            // intList[1] を変更
            testObj.intList[1] = 99;
            var intListProp = liveObj.FindProperty("intList");
        ...
        public void DeltaFormat_RoundTrip_PreservesValues()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-delta-array-7", liveClass, testObj);
            LivePropertyUtility.SetDefault(liveObj);
            ...
            var liveObj2 = new LiveObjectHandle("test-delta-array-7", liveClass, testObj2);
        ...
        #region Non-LiveClass Serializable Struct with Array Field Tests

        // LiveClass属性を持たないSerializable struct（内部にfloat[]を含む）
        ...
        [Serializable]
        [LiveClass("TestClassWithPlainStructField")]
        ...
        public void PlainStructWithArray_InPlaceModify_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainStructField));
            var liveObj = new LiveObjectHandle("test-plain-struct-1", liveClass, testObj);
            ...
            Assert.IsTrue(liveObj.IsPropertyDirty("structField"),
        ...
        public void PlainStructWithArray_StructReassignment_DetectedAsDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainStructField));
            var liveObj = new LiveObjectHandle("test-plain-struct-2", liveClass, testObj);
        ...
        public void PlainStructWithArray_UnchangedValues_NotDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainStructField));
            var liveObj = new LiveObjectHandle("test-plain-struct-3", liveClass, testObj);

            LivePropertyUtility.SetDefault(liveObj);

            // Assert - dirtyではない
            Assert.IsFalse(liveObj.IsPropertyDirty("structField"),
        ...
        public void PlainStructWithArray_SameContentNewArray_NotDirty()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainStructField));
            var liveObj = new LiveObjectHandle("test-plain-struct-4", liveClass, testObj);
        ...
        public void PlainStructWithArray_LiveSceneToJson_RoundTrip()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainStructField));
            var liveObj = new LiveObjectHandle("test-plain-struct-5", liveClass, testObj);
            ...
            var liveObj2 = new LiveObjectHandle("test-plain-struct-5", liveClass, testObj2);
            LivePropertyUtility.SetDefault(liveObj2);
        ...
        #region Non-LiveClass Persistable Property Tests

        // LiveClassでないSerializableクラス（AvatarInputSettingsと同パターン）
        [System.Serializable]
        ...
        // readOnlyな非LiveClassプロパティ（デルタ出力に含まれないべき）
        [System.Serializable]
        [LiveClass("TestClassWithReadOnlyPlainProperty")]
        ...
        [System.Serializable]
        [LiveClass("TestClassWithPlainSerializableProperty")]
        public class TestClassWithPlainSerializableProperty
        {
            [LiveField]
            public int id;

            // LiveClassでないSerializableクラスをLiveFieldとして持つ
            [LiveField]
            public PlainSerializableSettings settings = new PlainSerializableSettings();
        }

        [Test]
        public void NonLiveClassPersistableProperty_IncludedInDeltaOutput()
        {
            // Arrange - LiveClassでないSerializableクラスをPersistableプロパティとして持つ
            LiveClass.RegisterFromAttributes<TestClassWithPlainSerializableProperty>();
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainSerializableProperty));
            var liveObj = new LiveObjectHandle("test-plain-serializable-1", liveClass, testObj);
            ...
            // Delta出力
            var json = LivePropertySerializer.ToJson(liveObj, _resolver, isDirtyOnly: true, forPersistence: true);
            var jObj = JObject.Parse(json);

            // Assert - settingsが出力に含まれること
            Assert.IsNotNull(jObj["settings"], "Non-LiveClass persistable property 'settings' should be included in delta output");
            var settingsObj = jObj["settings"];
            Assert.AreEqual("Changed", settingsObj["deviceName"]?.Value<string>());
        }

        [Test]
        public void NonLiveClassPersistableProperty_UnchangedExcludedFromDelta()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainSerializableProperty));
            var liveObj = new LiveObjectHandle("test-plain-serializable-unchanged", liveClass, testObj);
            ...
            Assert.IsNull(jObj["settings"], "Unchanged non-LiveClass persistable property should NOT be included in delta");
            Assert.IsFalse(LivePropertySerializer.HasNonMetaProperties(jObj),
                "delta には非メタプロパティが無く、LiveSceneToJson からは除外されるべき");
        }

        [Test]
        public void NonLiveClassReadOnlyProperty_ExcludedFromDelta()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithReadOnlyPlainProperty));
            var liveObj = new LiveObjectHandle("test-readonly-plain", liveClass, testObj);
            ...
            Assert.IsNull(jObj["readOnlySettings"], "ReadOnly non-LiveClass property should be excluded from delta output");
        }

        [Test]
        public void NonLiveClassPersistableProperty_IncludedInSceneDelta()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestClassWithPlainSerializableProperty>();
            var testObj = new TestClassWithPlainSerializableProperty
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainSerializableProperty));
            var liveObj = new LiveObjectHandle("test-plain-serializable-2", liveClass, testObj);
            ...
            Assert.IsNotNull(objEntry["settings"], "Non-LiveClass persistable property 'settings' should be included in scene delta output");
        }

        [Test]
        public void NonLiveClassPersistableProperty_RoundTrip()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestClassWithPlainSerializableProperty>();
            var testObj = new TestClassWithPlainSerializableProperty
            ...
            var liveClass = LiveClass.Find(typeof(TestClassWithPlainSerializableProperty));
            var liveObj = new LiveObjectHandle("test-plain-serializable-3", liveClass, testObj);
            ...
            var liveObj2 = new LiveObjectHandle("test-plain-serializable-3", liveClass, testObj2);
            LivePropertyUtility.SetDefault(liveObj2);
        ...
        public void RevertArray_AfterDeltaLoad_RestoresArrayLength()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-revert-array", liveClass, testObj);
        ...
        public void PlayStopPlay_DeltaArrayDoesNotGrow()
        {
            ...
            var liveClass = LiveClass.Find(typeof(TestDirtyClassWithArray));
            var liveObj = new LiveObjectHandle("test-play-stop-play", liveClass, testObj);
            ...
            try
            {
                ...
                // --- Stop: Revert ---
                foreach (var path in liveObj.GetDirtyProperties())
                    liveObj.Revert(path);
