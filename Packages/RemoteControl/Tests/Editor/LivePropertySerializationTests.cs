...
{
    [TestFixture]
    public class LivePropertySerializationTests
    {
        #region Test Classes
        ...
        // LiveClassとして登録して使用するクラス（属性使用）
        [Serializable]
        [LiveClass("TestLiveParent")]
        public class LiveClassWithNonLiveMembers
        {
            [LiveField]
            ...
            public int unregisteredInt; // LiveProperty属性がないため登録されない
        }
        ...
        [Test]
        public void SerializeNonLiveClass_WithJsonUtility_SerializesCorrectly()
        {
            // Arrange
        ...
        [Test]
        public void SerializeNonLiveClass_WithNestedObject_SerializesCorrectly()
        {
            // Arrange
        ...
        [Test]
        public void DeserializeNonLiveClass_WithJsonUtility_DeserializesCorrectly()
        {
            // Arrange
            var json = "{\"value\":{\"intValue\":42,\"stringValue\":\"test\",\"floatValue\":3.14,\"boolValue\":true}}";

            // Act
            var result = LivePropertySerializer.FromJson<SimpleClass>(json);
        ...
        [Test]
        public void DeserializeNonLiveClass_WithExistingInstance_UpdatesValues()
        {
            // Arrange
            var json = "{\"value\":{\"intValue\":42,\"stringValue\":\"new\",\"floatValue\":3.14,\"boolValue\":true}}";

            // Act
            var result = LivePropertySerializer.FromJson(json, typeof(SimpleClass));
        ...
        [Test]
        public void DeserializeNonLiveClass_WithNestedObject_DeserializesCorrectly()
        {
            // Arrange
            var json = "{\"value\":{\"value\":100,\"simpleObject\":{\"intValue\":42,\"stringValue\":\"nested\"},\"nestedObject\":{\"id\":1,\"name\":\"test\"}}}";

            // Act
            var result = LivePropertySerializer.FromJson<ComplexClass>(json);
        ...
        public void SerializeDeserialize_RoundTrip_PreservesData()
        {
            ...
            // Act - Serialize
            var json = LivePropertySerializer.ToJson(original);
        ...
        [Test]
        public void SerializeNonLiveClass_WithArray_SerializesCorrectly()
        {
            // Arrange
            var obj = new ComplexClass
            {
        ...
        [Test]
        public void DeserializeNonLiveClass_WithArray_DeserializesCorrectly()
        {
            // Arrange
        ...
        #region LiveClass Tests

        [Test]
        public void SerializeLiveClass_WithNonLiveMember_SerializesOnlyRegisteredProperties()
        {
            // Arrange
            // 属性から自動登録
            LiveClass.RegisterFromAttributes<LiveClassWithNonLiveMembers>();

            var obj = new LiveClassWithNonLiveMembers
            {
            ...
            // @typeの確認
            Assert.AreEqual("TestLiveParent", valueToken["@type"]?.Value<string>());

            // simpleDataの確認（非LiveClassメンバ）
        ...
        [Test]
        public void DeserializeLiveClass_WithNonLiveMember_DeserializesCorrectly()
        {
            // Arrange
            // 属性から自動登録
            LiveClass.RegisterFromAttributes<LiveClassWithNonLiveMembers>();

            var json = "{\"value\":{\"@type\":\"LiveParent\",\"simpleData\":{\"@type\":\"SimpleClass\",\"intValue\":42,\"stringValue\":\"nested\",\"floatValue\":1.5,\"boolValue\":false},\"registeredInt\":100,\"registeredText\":\"test\"}}";

            // Act
            var result = LivePropertySerializer.FromJson<LiveClassWithNonLiveMembers>(json);

            // Assert
            Assert.IsNotNull(result);
            Assert.IsInstanceOf<LiveClassWithNonLiveMembers>(result);
        ...
        [Test]
        public void SerializeDeserialize_LiveClass_RoundTrip_PreservesData()
        {
            // Arrange
            // 属性から自動登録
            LiveClass.RegisterFromAttributes<LiveClassWithNonLiveMembers>();

            var original = new LiveClassWithNonLiveMembers
            {
                simpleData = new SimpleClass
                {
                    intValue = 42,
        ...
        [Test]
        public void SerializeLiveClass_WithArrayData_SerializesCorrectly()
        {
            // Arrange
            // 属性から自動登録
            LiveClass.RegisterFromAttributes<LiveClassWithNonLiveMembers>();
            ...
            // arrayDataの確認（非LiveClassで配列を持つメンバ）
        ...
        [Test]
        public void DeserializeLiveClass_WithArrayData_DeserializesCorrectly()
        {
            // Arrange
            // 属性から自動登録
            LiveClass.RegisterFromAttributes<LiveClassWithNonLiveMembers>();

            var json = "{\"value\":{\"@type\":\"LiveParent\",\"arrayData\":{\"@type\":\"ArrayClass\",\"arrayOfNested\":[{\"id\":1,\"name\":\"first\"},{\"id\":2,\"name\":\"second\"},{\"id\":3,\"name\":\"third\"}]},\"simpleData\":{\"@type\":\"SimpleClass\",\"intValue\":42,\"stringValue\":\"test\"},\"registeredInt\":100,\"registeredText\":\"sample\"}}";
        ...
        [Test]
        public void SerializeDeserialize_LiveClass_WithArrayData_RoundTrip_PreservesData()
        {
            // Arrange
            // 属性から自動登録
            LiveClass.RegisterFromAttributes<LiveClassWithNonLiveMembers>();
        ...
        {
            // Arrange
            // LiveClassに登録していないクラスの場合、JsonUtilityを使うため整数形式
        ...
        {
            // Arrange - 数値形式のEnum
            // LiveClassに登録していない場合はEnumは数字で出力   
            var json = "{\"value\":{\"priority\":2,\"name\":\"test\"}}";

            // Act
            var result = LivePropertySerializer.FromJson<ClassWithEnum>(json);
        ...
        // LiveObject参照テスト用のScriptableObject
        [LiveClass("TestRefSO")]
        ...
        [Serializable]
        [LiveClass("TestReadonlyRefClass")]
        public class TestReadonlyRefClass
        {
            ...
            [LiveProperty("meshNames")]
            public string[] meshNames => _meshNames;

            // readonly ScriptableObject — LiveObject参照なので InlineReference で永続化対象化
            private TestRefScriptableObject _refObj;

            [LiveProperty("refObj"), InlineReference]
            public TestRefScriptableObject refObj => _refObj;

            public void SetRefObj(TestRefScriptableObject obj) => _refObj = obj;

            // readonly ScriptableObject[] — 要素がLiveObject参照の配列なので InlineReference で永続化対象化
            private TestRefScriptableObject[] _refArray;

            [LiveProperty("refArray"), InlineReference]
            ...
            // 要素型自体(ScriptableObject)はLiveClassに未登録だが、
            // 派生型(TestRefScriptableObject)が登録されている
            private ScriptableObject[] _baseTypeRefArray;

            [LiveProperty("baseTypeRefArray"), InlineReference]
            ...
            [LiveProperty("readonlyInt")]
            public int readonlyInt => _readonlyInt;
        }

        [Test]
        public void ContainsLiveObjectReference_StringArray_ReturnsFalse()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestReadonlyRefClass>();
            var liveClass = LiveClass.Find(typeof(TestReadonlyRefClass));
            var meshNamesProp = liveClass.propertyTypes.First(p => p.name == "meshNames");

            // Assert
            Assert.IsTrue(meshNamesProp.isReadOnly);
            Assert.IsFalse(meshNamesProp.containsLiveObjectReference,
                "string[] should not be treated as LiveObjectHandle reference");
        }

        [Test]
        public void ContainsLiveObjectReference_SingleScriptableObject_ReturnsTrue()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestReadonlyRefClass>();
            var liveClass = LiveClass.Find(typeof(TestReadonlyRefClass));
            var refObjProp = liveClass.propertyTypes.First(p => p.name == "refObj");

            // Assert
            Assert.IsTrue(refObjProp.isReadOnly);
            Assert.IsTrue(refObjProp.containsLiveObjectReference,
                "ScriptableObject reference should be treated as LiveObjectHandle reference");
        }

        [Test]
        public void ContainsLiveObjectReference_ScriptableObjectArray_ReturnsTrue()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestReadonlyRefClass>();
            var liveClass = LiveClass.Find(typeof(TestReadonlyRefClass));
            var refArrayProp = liveClass.propertyTypes.First(p => p.name == "refArray");

            // Assert
            Assert.IsTrue(refArrayProp.isReadOnly);
            Assert.IsTrue(refArrayProp.containsLiveObjectReference,
                "ScriptableObject[] should be treated as containing LiveObjectHandle references");
        }

        [Test]
        public void ContainsLiveObjectReference_BaseTypeUnityObjectArray_ReturnsTrue()
        {
            // Arrange — Component[]と同じパターン：ベース型(ScriptableObject)自体はLiveClass未登録
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestReadonlyRefClass>();
            var liveClass = LiveClass.Find(typeof(TestReadonlyRefClass));
            var baseRefArrayProp = liveClass.propertyTypes.First(p => p.name == "baseTypeRefArray");

            // Assert
            Assert.IsTrue(baseRefArrayProp.isReadOnly);
            Assert.IsFalse(LiveClass.Has(typeof(ScriptableObject)),
                "ScriptableObject itself should not be registered as LiveClass");
            Assert.IsTrue(baseRefArrayProp.containsLiveObjectReference,
                "ScriptableObject[] (base type array) should be treated as containing LiveObjectHandle references");
        }

        [Test]
        public void ContainsLiveObjectReference_ReadonlyPrimitive_ReturnsFalse()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestReadonlyRefClass>();
            var liveClass = LiveClass.Find(typeof(TestReadonlyRefClass));
            var readonlyIntProp = liveClass.propertyTypes.First(p => p.name == "readonlyInt");

            // Assert
            Assert.IsTrue(readonlyIntProp.isReadOnly);
            Assert.IsFalse(readonlyIntProp.containsLiveObjectReference,
                "readonly int should not be treated as LiveObjectHandle reference");
        }
        ...
        public void ToJson_ForPersistence_SkipsReadonlyStringArray()
        {
            ...
            var liveObj = new LiveObjectHandle("test-readonly-1", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();

            try
            {
                // Act
                var json = LivePropertySerializer.ToJson(liveObj, resolver, forPersistence: true);
                var jObject = JObject.Parse(json);
        ...
        [Test]
        public void ToJson_ForPersistence_IncludesReadonlyLiveObjectReference()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestReadonlyRefClass>();
            ...
            var soLiveClass = LiveClass.Find(typeof(TestRefScriptableObject));
            var soLiveObj = new LiveObjectHandle("so-ref-1", soLiveClass, soInstance);

            var liveClass = LiveClass.Find(typeof(TestReadonlyRefClass));
            var testObj = new TestReadonlyRefClass { writableValue = 1 };
            testObj.SetRefObj(soInstance);
            var liveObj = new LiveObjectHandle("test-readonly-2", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();
            ...
            try
            {
                ...
                Assert.IsNotNull(refObjToken,
                    "readonly LiveObjectHandle reference (refObj) should be included in persistence output");
                Assert.AreEqual("so-ref-1", refObjToken["@ref"]?.Value<string>(),
                    "refObj should contain @ref pointing to the LiveObjectHandle id");
            }
            finally
            {
                liveObj.Unregister();
                soLiveObj.Unregister();
                ScriptableObject.DestroyImmediate(soInstance);
            }
        }

        [Test]
        public void ToJson_ForPersistence_IncludesReadonlyLiveObjectArray()
        {
            // Arrange
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestReadonlyRefClass>();
            ...
            var soLiveClass = LiveClass.Find(typeof(TestRefScriptableObject));
            var soLive1 = new LiveObjectHandle("so-arr-1", soLiveClass, so1);
            var soLive2 = new LiveObjectHandle("so-arr-2", soLiveClass, so2);

            var liveClass = LiveClass.Find(typeof(TestReadonlyRefClass));
            var testObj = new TestReadonlyRefClass { writableValue = 2 };
            testObj.SetRefArray(new[] { so1, so2 });
            var liveObj = new LiveObjectHandle("test-readonly-3", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();
            ...
            try
            {
                ...
                Assert.IsNotNull(refArrayToken,
                    "readonly LiveObjectHandle[] (refArray) should be included in persistence output");
        ...
        public void ToJson_ForPersistence_IncludesReadonlyBaseTypeUnityObjectArray()
        {
            ...
            var so2 = ScriptableObject.CreateInstance<TestRefScriptableObject>();
            var soLiveClass = LiveClass.Find(typeof(TestRefScriptableObject));
            var soLive1 = new LiveObjectHandle("so-base-1", soLiveClass, so1);
            var soLive2 = new LiveObjectHandle("so-base-2", soLiveClass, so2);
            ...
            var liveObj = new LiveObjectHandle("test-readonly-5", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();
        ...
        public void ToJson_NotForPersistence_IncludesAllReadonlyProperties()
        {
            ...
            var liveObj = new LiveObjectHandle("test-readonly-4", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();

            try
            {
                // Act — forPersistence = false（通常のシリアライズ）
                var json = LivePropertySerializer.ToJson(liveObj, resolver, forPersistence: false);
                var jObject = JObject.Parse(json);
        ...
        #region Nested LiveObjectHandle Readonly Persistence Tests

        // ネストされたLiveClassオブジェクト内のreadonly/非persistableプロパティのテスト用
        [Serializable]
        [LiveClass("TestNestedChild")]
        ...
        [Test]
        public void SerializeNestedLiveObject_ForPersistence_ExcludesReadonlyProperties()
        {
            // Arrange — ネストされたLiveClassオブジェクト内のreadonly/非persistableプロパティが
            // forPersistence=true 時にスキップされることを確認
            LiveClass.RegisterFromAttributes<TestNestedChild>();
            LiveClass.RegisterFromAttributes<TestNestedParent>();

            var liveClass = LiveClass.Find(typeof(TestNestedParent));
            var testObj = new TestNestedParent
            {
                parentValue = 10,
                child = new TestNestedChild { writableValue = 5 }
            };
            var liveObj = new LiveObjectHandle("test-nested-readonly", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();
            ...
            try
            {
                ...
                // Assert — childのreadonly persistableプロパティもスキップされる（LiveObject参照でないため）
        ...
        [Test]
        public void SerializeNestedLiveObject_NonPersistence_IncludesReadonlyProperties()
        {
            // Arrange — forPersistence=false の場合、ネストされたLiveClassオブジェクト内の
            ...
            var liveObj = new LiveObjectHandle("test-nested-nonpersist", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();
        ...
        #region DeltaFromDefault LiveObjectHandle Reference Tests

        // DeltaFromDefaultテスト用: 書き込み可能なLiveObject参照を持つクラス
        [Serializable]
        [LiveClass("TestDeltaFromDefaultRefClass")]
        ...
        [Test]
        public void ToJson_DeltaFromDefault_SkipsNonDirtyLiveObjectReference()
        {
            // Arrange — LiveObject参照を持つがdirtyでないプロパティが
            // onlyDirty=true でスキップされることを確認
            LiveClass.RegisterFromAttributes<TestRefScriptableObject>();
            LiveClass.RegisterFromAttributes<TestDeltaFromDefaultRefClass>();

            var soInstance = ScriptableObject.CreateInstance<TestRefScriptableObject>();
            soInstance.soValue = 10;
            var soLiveClass = LiveClass.Find(typeof(TestRefScriptableObject));
            var soLiveObj = new LiveObjectHandle("dirty-so-1", soLiveClass, soInstance);

            var liveClass = LiveClass.Find(typeof(TestDeltaFromDefaultRefClass));
            var testObj = new TestDeltaFromDefaultRefClass { normalValue = 5, config = soInstance };
            var liveObj = new LiveObjectHandle("dirty-ref-test", liveClass, testObj);
            var resolver = new TestLiveObjectResolver();
            ...
            try
            {
                ...
                var json = LivePropertySerializer.ToJson(liveObj, resolver, isDirtyOnly: true, forPersistence: true);
                var jObject = JObject.Parse(json);
                ...
                // Assert — dirtyでないLiveObject参照もスキップされる
                Assert.IsNull(jObject["config"],
                    "non-dirty LiveObjectHandle reference (config) should be skipped in DeltaFromDefault mode");
            }
            finally
            {
                liveObj.Unregister();
        ...
        {
            LiveClass.RegisterFromAttributes<TransformValueHolder>();
        ...
        public void TransformValue_RoundTrip_PreservesValue()
        {
            ...
            var json = LivePropertySerializer.ToJson(original);
            var result = LivePropertySerializer.FromJson<TransformValueHolder>(json);
        ...
        public void TransformValue_PartialDeserialize_FallsBackToExisting()
        {
            ...
            var resultObj = LivePropertySerializer.DeserializeLiveObject(resolver, token, typeof(TransformValueHolder), existing);
