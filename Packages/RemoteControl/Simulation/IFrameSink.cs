...
{
    /// <summary>
    /// Receives every frame once it is complete: after its events have been applied and after the
    ...
    /// a buffer: this runs inside the point every event is waiting on.
    /// </summary>
